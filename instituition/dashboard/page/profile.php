              ...
              <form>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <input value="<?php echo$email; ?>"  class="form-control"  type="email" disabled>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="pl-lg-4">
                  <div class="row">
                     ...
                     <div class="col-md-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-address">Instituition Name</label>
                        <input value="<?php echo$instituition_name; ?>"   class="form-control"  type="text" >
                      </div>
                    </div>
                        <div class="col-md-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-address">Instituition Address</label>
